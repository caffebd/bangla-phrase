...
var word_audio = {
	...
	"baks": preload("res://assets/audio/words/bichana.mp3"),
	"balti": preload("res://assets/audio/words/bichana.mp3"),
	"ghrri": preload("res://assets/audio/words/bichana.mp3"),
	"dab": preload("res://assets/audio/words/bichana.mp3"),
	"gru": preload("res://assets/audio/words/bichana.mp3"),
	"hrinn": preload("res://assets/audio/words/bichana.mp3"),
	"desk": preload("res://assets/audio/words/bichana.mp3"),
	"dim": preload("res://assets/audio/words/bichana.mp3"),
	"ghr": preload("res://assets/audio/words/bichana.mp3"),
	"jg": preload("res://assets/audio/words/bichana.mp3"),
	"am": preload("res://assets/audio/words/bichana.mp3"),
